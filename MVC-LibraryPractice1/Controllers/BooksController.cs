...
namespace MVC_LibraryPractice1.Controllers
{
    public class BooksController : Controller
    {
        private readonly LibraryPractice1Context _context;

        public BooksController(LibraryPractice1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Book != null ? 
                          ...
                          Problem("Entity set 'LibraryPractice1Context.Book'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LibraryPractice1Context.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
